...
namespace TRAINEE
{
    public class EquipRadioView : EquipBaseView
    {
        public override void Init(string itemid, string instanceid, string ownerId)
        {
            Debug.Log($"EquipRadioView Init - id : {itemid} / insid : {instanceid} / ownerid : {ownerId}");
        ...
        public override void OnStartClient()
        {
            ...
            Debug.Log($"EquipRadioView  id : {_itemid.Value} / insid : {_instanceId.Value} / ownerid : {_ownerId.Value}");
